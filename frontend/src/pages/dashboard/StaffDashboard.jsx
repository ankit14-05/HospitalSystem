...
import { Bed, ClipboardList, Users, CheckCircle, Clock, AlertTriangle } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';

const ROLE_LABELS = {
  nurse:'Nurse', receptionist:'Receptionist',
  pharmacist:'Pharmacist', labtech:'Lab Technician',
};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          ...
          <div className="divide-y divide-slate-50">
            {tasks.map(t => (
              <div key={t.id}
                className={`flex items-center gap-3 px-6 py-3.5 border-l-4 ${PRIORITY_COLORS[t.priority]} ${t.done ? 'opacity-50' : ''}`}>
                <button
                  ...
                  <div className="flex-1">
                    {b.patient
                      ...
                      : <p className="text-sm text-slate-400 italic">
                          {b.status==='cleaning' ? 'Being cleaned' : 'Available'}
                        </p>
                    }
                  </div>
